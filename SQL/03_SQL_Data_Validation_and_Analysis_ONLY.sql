-- ============================================================
-- Barclays Banking Analytics Project
-- 03_SQL_Data_Validation_and_Analysis.sql
--
-- PURPOSE:
-- Direct SQL validation and business analysis only.
--
-- IMPORTANT:
-- This script does NOT create databases or tables.
-- It assumes these four tables already exist:
--   Customers
--   Accounts
--   Transactions
--   Branches
--
-- The queries are based on the cleaned datasets.
-- ============================================================
